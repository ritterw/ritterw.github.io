...
function searchbar_listener(event) {
    ...
    if (q !== '') {
      var url = 'https://github.com/ritterw/ritterw.github.io/search?utf8=✓&q=' + encodeURIComponent(q);
...
function router() {
  ...
  $.get(path, function(data) {
    ...
    (function() {
      ...
      window.disqus_url = 'http://www.smartx.im, b: number)/' + (location.hash ? location.hash.replace("#", "") : 'README');
